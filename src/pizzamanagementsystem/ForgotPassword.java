...
public class ForgotPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtSecurityQuestion = new java.awt.TextField();
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 240, 371, -1));

        txtSecurityQuestion.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        txtSecurityQuestion.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtSecurityQuestionKeyReleased(evt);
            }
        });
        getContentPane().add(txtSecurityQuestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 280, 371, -1));

        txtAnswer.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        txtAnswer.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtAnswerKeyReleased(evt);
            }
        });
        getContentPane().add(txtAnswer, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 310, 371, -1));
        ...
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 350, 371, -1));
        ...
        getContentPane().add(btnSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 230, -1, -1));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 380, -1, -1));
        ...
        getContentPane().add(btnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 380, -1, -1));
        ...
        getContentPane().add(btnLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 420, -1, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 380, -1, -1));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        email = txtEmail.getText();
        Database user = null;
        user = User.getSecurityQuestion(email);
        if (user == null) {
            JOptionPane.showMessageDialog(null, "Incorrect Email", "Message", JOptionPane.ERROR_MESSAGE);
        } else {
            btnSearch.setEnabled(false);
            txtEmail.setEditable(false);
            dbAnswer = user.getUanswer();
            txtSecurityQuestion.setText(user.getUsecurityQuestion());
            validateFields();
        }
    ...
    private java.awt.TextField txtSecurityQuestion;
